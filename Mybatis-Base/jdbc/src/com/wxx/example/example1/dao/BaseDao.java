package com.wxx.example.example1.dao;
...
public abstract class BaseDao {
    ...
    public <T> T getInstanceWithTx(Connection conn, Class<T> clazz, String sql, Object... args) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            // 1.获取数据库的连接 ---- 此时不需要这一步骤
    ...
    public <T> List<T> getForListWithTx(Connection conn, Class<T> clazz, String sql, Object... args) {
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            // 1.获取数据库的连接 ---- 此时不需要这一步骤
